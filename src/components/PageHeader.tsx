...
export function PageHeader({
  ...
  return <div className="flex items-center justify-between px-6 tablet:px-4 py-3.5 tablet:py-2.5">
      <div>
        <h1 className="text-2xl tablet:text-xl font-bold text-gray-900">{title}</h1>
        {description && <p className="text-gray-600 tablet:text-sm mt-1">{description}</p>}
      </div>
