...
export const IntraOralSection = ({ formData, setFormData }: IntraOralSectionProps) => {
  ...
  const mallampatiScores = [
    { id: 'class_1', label: 'Class I', image: '/images/head-neck/mallampati-class-1.png' },
    { id: 'class_2', label: 'Class II', image: '/images/head-neck/mallampati-class-2.png' },
    { id: 'class_3', label: 'Class III', image: '/images/head-neck/mallampati-class-3.png' },
    { id: 'class_4', label: 'Class IV', image: '/images/head-neck/mallampati-class-4.png' }
  ];

  const malocclusion = [
    { id: 'normal', label: 'Normal Occlusion', image: '/images/head-neck/malocclusion-normal.png' },
    { id: 'cross_bite', label: 'Cross Bite', image: '/images/head-neck/malocclusion-cross.png' },
    { id: 'open_bite', label: 'Open Bite', image: '/images/head-neck/malocclusion-open.png' },
    { id: 'deep_bite', label: 'Deep Bite', image: '/images/head-neck/malocclusion-deep.png' }
  ];
